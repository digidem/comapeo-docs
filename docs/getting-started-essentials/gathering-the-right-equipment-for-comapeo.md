...
![Minimum_Requirements.png](/images/gatheringtherightequ_0.png)
...
CoMapeo Mobile is currently built for <img src="/comapeo-docs/images/emojis/android-head_3d_182d654c7a9e6c2b_10131033.png" alt="android" className="emoji" style={{display: "inline", height: "1.2em", width: "auto", verticalAlign: "text-bottom", margin: "0 0.1em"}} /> **Android** smartphones.  It will not work with iPhones.
...
**There are three options to choose from**
 ...
 <img src="/comapeo-docs/images/emojis/right-arrow_241f861b8bb8e877_10130985.png" alt="right-arrow-black" className="emoji" style={{display: "inline", height: "1.2em", width: "auto", verticalAlign: "text-bottom", margin: "0 0.1em"}} /> **Conventional router** installed in an office or communications center


    👍🏽 Pros: Location of the wifi is consistent and predictable for teammates 


    👎🏽 Cons: Shared wifi passwords may reach people outside of the project. Device security settings are recommended


<img src="/comapeo-docs/images/emojis/right-arrow_241f861b8bb8e877_10130985.png" alt="right-arrow-black" className="emoji" style={{display: "inline", height: "1.2em", width: "auto", verticalAlign: "text-bottom", margin: "0 0.1em"}} />  **Portable router**


    👍🏽 Pros: Small lightweight make it easy to add to a gear bag for trips and trecks


    👎🏽 Cons: An additional piece of equipment to care for that also requires a power supply


<img src="/comapeo-docs/images/emojis/right-arrow_241f861b8bb8e877_10130985.png" alt="right-arrow-black" className="emoji" style={{display: "inline", height: "1.2em", width: "auto", verticalAlign: "text-bottom", margin: "0 0.1em"}} /> **Additional smartphone** capable of creating a local network offline or hotspot.


    👍🏽 Pros: Smartphones are easy to access in most groups of people


    👎🏽 Cons: The device serving as the Wi-Fi connection cannot participate in the CoMapeo Collaborations at the same time. Solved by taking turns.
