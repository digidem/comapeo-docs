...
Here you will learn what to do on your <img src="/comapeo-docs/images/emojis/android-head_3d_182d654c7a9e6c2b_63902843.png" alt="android" className="emoji" style={{display: "inline", height: "1.2em", width: "auto", verticalAlign: "text-bottom", margin: "0 0.1em"}} /> Android smartphone or tablet phone (outside of CoMapeo) to get the best performance from it as you start to use it.
