  ...
  paths: {
    ...
    "/jobs": {
      ...
      post: {
        summary: "Create job",
        description:
          "Create and trigger a new job. Fetch jobs return 202 Accepted after enqueue; legacy job types may return 201 Created.",
        tags: ["Jobs"],
        requestBody: {
          required: true,
          content: {
        ...
        responses: {
          "202": {
            description: "Job accepted and enqueued (fetch job types)",
            content: {
              "application/json": {
                schema: {
          ...
          "201": {
            description: "Job created successfully (legacy job types)",
            content: {
              "application/json": {
                schema: {
                  $ref: "#/components/schemas/CreateJobResponse",
