...
Next, we provide a list of the app permissions that **CoMapeo** needs for different functionality

- **Camera** 📷**(while the app is being used)**: for taking pictures attached to observations
- **GPS** <img src="/comapeo-docs/images/emojis/gps_9dba27a9d6b52176_63901977.png" alt="app-icon-gps20" className="emoji" style={{display: "inline", height: "1.2em", width: "auto", verticalAlign: "text-bottom", margin: "0 0.1em"}} /> **(while the app is being used)**: for geolocation of the user and adding observations with correct coordinates
- **GPS** <img src="/comapeo-docs/images/emojis/gps_9dba27a9d6b52176_63901977.png" alt="app-icon-gps20" className="emoji" style={{display: "inline", height: "1.2em", width: "auto", verticalAlign: "text-bottom", margin: "0 0.1em"}} /> **(all the time)**: for recording tracks while the app is not focused, or the phone has the screen off
- **Audio** <img src="/comapeo-docs/images/emojis/add_audio_183c1246924bddc3_63901988.png" alt="app-icon-add-audio" className="emoji" style={{display: "inline", height: "1.2em", width: "auto", verticalAlign: "text-bottom", margin: "0 0.1em"}} /> **(while the app is being used):** for recording audio attached to observations
