...
CoMapeo Mobile is currently built for <img src="/images/emojis/android-head_3d_182d654c7a9e6c2b_15659575.png" alt="android" className="emoji" style={{display: "inline", height: "1.2em", width: "auto", verticalAlign: "text-bottom", margin: "0 0.1em"}} /> **Android** smartphones.  It will not work with iPhones.
...
**There are three options to choose from**
 ...
 <img src="/images/emojis/right-arrow_241f861b8bb8e877_15658101.png" alt="right-arrow-black" className="emoji" style={{display: "inline", height: "1.2em", width: "auto", verticalAlign: "text-bottom", margin: "0 0.1em"}} /> **Conventional router** installed in an office or communications center


<img src="/images/emojis/right-arrow_241f861b8bb8e877_15658101.png" alt="right-arrow-black" className="emoji" style={{display: "inline", height: "1.2em", width: "auto", verticalAlign: "text-bottom", margin: "0 0.1em"}} />  **Portable router**


<img src="/images/emojis/right-arrow_241f861b8bb8e877_15658101.png" alt="right-arrow-black" className="emoji" style={{display: "inline", height: "1.2em", width: "auto", verticalAlign: "text-bottom", margin: "0 0.1em"}} /> **Additional smartphone** capable of creating a local network offline or hotspot.
