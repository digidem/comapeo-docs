...
---
![](/images/understandingcomapeo_0.png)
...
**Participatory mapping projects not only lead to stronger mapping outcomes, but because they involve conversations about the land or water, they can help restart or strengthen community processes.**
...
Maps can help outsiders understand the importance of the land from a local point of view, by representing things in a format legible to them. Information collected by communities using CoMapeo has been submitted to national governments around the world, from Kenya to Brazil, the Solomon Islands to Peru. Indigenous partners have used it as data in landmark legal victories, to backup testimonies and create map based evidence to prove their ancestral relationship to the land against evictions or diverse threats against the territory. In other cases CoMapeo has proven a powerful tool for biodiversity monitoring and for Indigenous communities to prove the efficacy of community-based territorial management in order to secure their land rights.
