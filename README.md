...
Content itself (`docs/`, `i18n/`, `static/images/notion/`) is generated by [`digidem/comapeo-content-pipeline`](https://github.com/digidem/comapeo-content-pipeline) — see that repo's [`DEPLOYMENT.md`](https://github.com/digidem/comapeo-content-pipeline/blob/main/DEPLOYMENT.md) for the end-to-end process of getting a Notion edit onto the `content` branch here.
