...
![https://comapeo.app](/images/introduction_0.png)
...
If you are not updating CoMapeo intentionally, you can access archived documentation for the version you are using in this platform.  (Coming soon!)
