---
id: "troubleshooting-mapping-with-collaborators"
...
custom_edit_url: "https://www.notion.so/2a71b08162d5809c8295f8a3c2d0709c"
source: notion
notion_page_id: "2a71b081-62d5-809c-8295-f8a3c2d0709c"
notion_last_edited_time: "2026-04-22T03:58:00.000Z"
content_hash: "sha256:4aee03da1209f60d0752ac352aa0698462aacb6f5d0be944043716e85f0d90a8"
status: draft
locale: en
...
![image](assets/0f2e0b3c850f88e2a2e8de27702c39542c3af73f6e7fec4b8a0c9e8d150a21b5.png)
✔️ Confirm all devices that want to exchange data are using the same WiFi network
![image](assets/537af8d7587aa7eef652001fe538ac28ecfa987e26d34c64e6c459bd3274bbc5.png)
...
***Step 2:*** Connect device 1,2 and 3 to the same network and exchange data
***Step 3:*** Connect device 3,4,5 and 6 to the same network and exchange data
***Step 4:*** Finally connect device 1,2 and 3 to the same network and exchange data
That way:
...
1. Verify on the exchange screen which Wifi network is being used
1. If any devices are connected to the wrong one, reconnect to the agreed WiFi network 
1. Tap Exchange
...
1. Verify that all required services and connections are active

1. Review recent changes to configuration or data that might impact functionality
