...
After consulting the troubleshooting and common solution pages, you may want to connect with a human to resolve and issue. You can email [**help@comapeo.app**](mailto:help@comapeo.app) with details about your experience and include screen captures to help explain what is not working as expected
