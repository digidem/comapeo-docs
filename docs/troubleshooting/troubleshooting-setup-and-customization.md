...
The only way to change a device name for use in CoMapeo is to use that same device and access <img src="/images/emojis/app_settings_2c4335fb69ab490d_15688166.png" alt="app-icon-app-settings" className="emoji" style={{display: "inline", height: "1.2em", width: "auto", verticalAlign: "text-bottom", margin: "0 0.1em"}} /> CoMapeo Settings → Device Name.  
