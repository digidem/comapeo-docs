...
describe('notion-fetch-all', () => {
  ...
  describe('parseArgs', () => {
    it('should parse command line arguments correctly', () => {
      ...
      process.argv = ['node', 'script', '--verbose', '--output-format', 'json', '--comparison'];
    ...
    it('should handle output and sorting options', () => {
      const originalArgv = process.argv;
      process.argv = ['node', 'script', '--output', 'test.html', '--sort-by', 'modified', '--sort-desc'];
    ...
    it('should handle include options', () => {
      const originalArgv = process.argv;
      process.argv = ['node', 'script', '--include-archived', '--include-removed'];
  ...
  describe('main function', () => {
    beforeEach(() => {
      ...
      vi.mocked(PreviewGenerator.generatePreview).mockResolvedValue(mockPreview);
      vi.mocked(StatusAnalyzer.analyzePublicationStatus).mockReturnValue(mockAnalysis);
      ...
      vi.mocked(ComparisonEngine.compareWithPublished).mockResolvedValue(mockComparison);
    ...
    it('should handle preview generation errors', async () => {
      vi.mocked(PreviewGenerator.generatePreview).mockRejectedValue(new Error('Preview Error'));
