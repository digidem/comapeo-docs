...
custom_edit_url: "https://www.notion.so/3131b08162d580448c84de608bda09ee"
source: notion
...
:::note 👉🏽
Go to 🔗 [Changing Background Maps](/es/docs/creating-custom-background-maps)  for illustrated instructions.
...
Go to 🔗 [Planning and Preparing for a Project](/es/docs/planning-and-preparing-for-a-project) 

Go to 🔗 [Changing Background Maps](/es/docs/changing-background-maps)  

---

### Having Problems?

Go to 🔗 [Troubleshooting: Setup and Customization → Custom Categories Set Problems](/es/docs/troubleshooting-setup-and-customization#custom-category-set-problems) 
