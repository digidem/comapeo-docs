...
- 2 or more devices with CoMapeo,
    ...
    ![](/images/usingexchangeoffline_0.png)
...
- devices are connected to the same WiFi connection
    ...
    ![](/images/usingexchangeoffline_2.png)

- devices belong to the same project
- new collected data

    ![](/images/usingexchangeoffline_3.png)
...
> ### 👣 Step by Step  
>   
> _**Step 1:**_ Open the <img src="/images/emojis/three-line-menu_351bd29be717f58f_15628661.png" alt="three-line-menu-black" className="emoji" style={{display: "inline", height: "1.2em", width: "auto", verticalAlign: "text-bottom", margin: "0 0.1em"}} />Menu  
>   
> _**Step 2:**_ Tap <img src="/images/emojis/remote_archive_70c2034a3fd6001e_15841752.png" alt="app-icon-comapeo-remote-archiver" className="emoji" style={{display: "inline", height: "1.2em", width: "auto", verticalAlign: "text-bottom", margin: "0 0.1em"}} /> _**Exchange**_  
>   
...
>   
> _**Step 6:**_ **Complete** will display when all observations are exchanged. Tap **Done** to return to <img src="/images/emojis/three-line-menu_351bd29be717f58f_15628661.png" alt="three-line-menu-black" className="emoji" style={{display: "inline", height: "1.2em", width: "auto", verticalAlign: "text-bottom", margin: "0 0.1em"}} />Menu
